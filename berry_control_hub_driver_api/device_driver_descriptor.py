...
from berry_control_hub_driver_api.device_driver import DeviceDriver
from berry_control_hub_driver_api.device_info import DeviceInfo
...
@pluginlib.Parent(plugin_type='DeviceDriverDescriptor', group='BerryControlHub')
